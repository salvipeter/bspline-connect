...
// Here `master' and `slave' are assumed to have the same degree and knot vector
// in the `u' parametric direction. The range of both parameters is [0,1],
// the common boundary is `u=0', and the `v'-orientation is compatible,
// i.e., C0-continuity is `M(0, v) = S(0, v)'.
